...
def searchTransportation():
    ...
    query = ('SELECT TransportationMethod.Id, TransportationMethod.Cost, TransportationMethod.Method FROM TransportationMethod, TravelsTo WHERE TransportationMethod.Id = TravelsTo.TransportationId AND TravelsTo.SourceId = %s AND TravelsTo.DestinationId = %s')
